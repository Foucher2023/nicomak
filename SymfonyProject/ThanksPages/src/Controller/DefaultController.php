    ...
    public function index(): Response
    {
        return $this->render('default.html.twig', [
            'entreprise' => [
                ...
                'description2' => 'Afin de démonter mes capacités technologiques j’ai donc eu pour mission de concevoir et développer une application web conviviale permettant aux salariés de Nicomak de s\'auto-congratuler L’objectif est de donner à chacun la possibilité d’exprimer sa reconnaissance de manière simple et directe, qu’il s’agisse d’une petite aide du quotidien ou d’un geste plus important.
Ce projet a également pour vocation de déterminer si mon profil pourrait s’intégrer à l’équipe Nicomak. cette mission est une belle opportunité de démontrer ma maîtrise technique et ma créativité en matière de développement web.',
            ],
        ]);
    }
}
